...
export default async function ExpensesPage() {
  ...
  return (
    <div>
      <h1 className="text-xl font-bold text-navy mb-5">NBV Internal Expenses</h1>
      ...
      <div className="grid lg:grid-cols-2 gap-4">
        <div className="card">
          ...
          <table className="w-full">
            <thead><tr><th>Date</th><th>Vendor</th><th>Category</th><th>Amount</th><th>ITC</th><th>Status</th></tr></thead>
            <tbody>
              {expenses.map((e) => (
                <tr key={e.id}>
                  ...
                  <td><span className={`pill ${e.status === "INBOX" ? "pill-amber" : "pill-green"}`}>{e.status}</span></td>
                </tr>
              ))}
            </tbody>
          </table>
